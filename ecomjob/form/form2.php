                ...
                <div class="md:flex w-full">
                    ...
                    <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                        ...
                        <form action="../auth/register_auth.php" method="post">
                            ...
                            <div class="flex -mx-3">
                                <div class="w-1/2 px-3 mb-5">
                                    <label for="" class="text-xs font-semibold px-1">Business Name</label>
                                    <div class="flex">
                                        ...
                                        <input name="business_name" type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Nikyyy Store">
                                    </div>
                                </div>
                                <div class="w-1/2 px-3 mb-5">
                            ...
                            <div class="mb-4"> 
                                ...
                                <div class="relative h-40 rounded-lg border-dashed border-2 border-gray-200 bg-white flex justify-center items-center hover:cursor-pointer">
                                    <div class="absolute">
                                        ...
                                        <span class="block text-gray-400 font-normal">Drag and Drop your files here</span> 
                            ...
                            <div class="flex -mx-3">
                                ...
                                <div class="w-full px-3 mb-5">
                                    <button name="seller_register_button" class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">REGISTER NOW</button>
                                </div>
                            </div>
                        </form>
                        <a href="../form.php">
