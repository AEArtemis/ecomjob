...
<body>
    ...
    <div class="header">
        ...
        <div class="flex items-center justify-center py-12 px-3 lg:py-6">
            <div class="mt-5 bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
                <div class="md:flex w-full">
                    ...
                    <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                        <div class="text-center mb-10">
                            <h1 class="font-bold text-3xl text-gray-900">Welcome User😊</h1>
                        ...
                        <form action="../auth/register_auth.php" method="post">
                            <div class="flex -mx-3">
                                <div class="w-1/2 px-3 mb-5">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input name="full_name" type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="John" required>
                                    </div>
                                </div>
                                <div class="w-1/2 px-3 mb-5">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input name="email" type="email" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="email@gmail.com" required>
                                    </div>
                                </div>
                            </div>
                            <div class="flex -mx-3">
                                <div class="w-1/2 px-3 mb-5">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input name="address" type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Tabaco City"required>
                                    </div>
                                </div>
                            </div>
                            <div class="flex -mx-3">
                                <div class="w-1/2 px-3 mb-5">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input name="contact" type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="0970 345 2345"required>
                                    </div>
                                </div>
                                <div class="w-1/2 px-3 mb-5">
                            ...
                            <input name="user" type="text" value="1" hidden>
                            <div class="flex -mx-3">
                                
                                <div class="w-full px-3 mb-5">
                                    <button name="user_register_button" class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">REGISTER NOW</button>
                                </div>
                            </div>
                        </form>
                        <a href="../form.php">
                            <div class="w-full px-3 mb-5">
                                <button class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold" name="user_register_button">Back</button>
                            </div>
                        </a>
                    </div>
                </div>
