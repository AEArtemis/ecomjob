                ...
                <div class="md:flex w-full">
                    ...
                    <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                        <div class="text-center mb-10">
                            <h1 class="font-bold text-3xl text-gray-900">Welcome Manager😊</h1>
                            <p>Enter your information to register your Jobs</p>
                        </div>
                        <form action="../auth/register_auth.php" method="post">
                            <div class="flex -mx-3">
                                <div class="w-1/2 px-3 mb-5">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input name="full_name" type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="John">
                                    </div>
                                </div>
                                <div class="w-1/2 px-3 mb-5">
                            ...
                            <div class="flex -mx-3">
                                <div class="w-1/2 px-3 mb-5">
                                    <label for="" class="text-xs font-semibold px-1">Company Name</label>
                                    <div class="flex">
                                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-store-outline text-gray-400 text-lg"></i></div>
                                        <input name="company_name" type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Nikyyy Store">
                                    </div>
                                </div>
                                <div class="w-1/2 px-3 mb-5">
                            ...
                            <input name="manager" type="text" value="3" hidden>
                            <div class="flex -mx-3">
                                
                                <div class="w-full px-3 mb-5">
                                    <button name="employer_register_button" class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">REGISTER NOW</button>
                                </div>
                            </div>
                        </form>
                        <a href="../form.php">
